...
computed at all. This package includes an algorithm to *exactly* compuate
spatially constrained clusters. The algorithm is as efficient as can be, but is
of course slower than approximate algorithms. It is neverthelsss exact.
...
For comparison, this package also includes the REDCAP collection of algorithms
described in [D. Guo's 2008 paper, "Regionalization with
dynamically constrained agglomerative clutering and
